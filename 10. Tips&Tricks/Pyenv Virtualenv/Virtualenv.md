...
To bypass local dependency conflicts and the lack of MediaPipe support for Python 3.13, this project containerizes the **Face AI Service** of the [**OpenAI Faceinterpretor**](https://github.com/MartinsRepo/Arduino-Uno-Q-Projects/tree/main/05.%20Application%20Development/OpenAI%20FaceInterpretor/App.md) using **Podman**. This ensures a stable **Python 3.12** environment with direct hardware access to the camera, providing a seamless AI-processing API for the Arduino Lab MicroPython script.
